    ...
    <div className="p-6 max-w-[1600px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <select value={categoriaSelecionada} onChange={(e) => { setCategoriaSelecionada(e.target.value); setPagina(1) }} className="w-full mt-1 text-2xl font-bold text-gray-900 border-none p-0 focus:ring-0 bg-transparent">
